import InsurancePolicyInsertForm from "../components/InsurancePolicyInsertForm.tsx";
import {useIsAdmin} from "@/hooks/useRoles.ts";
const InsurancePolicyInsertFormPage = () => {
...
export default InsurancePolicyInsertFormPage;