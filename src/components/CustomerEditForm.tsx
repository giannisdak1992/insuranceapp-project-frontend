...
const CustomerEditForm = () => {
    ...
    const onSubmit = async (data: CustomerUpdateDTO) => {
        try {
            ...
            alert("Error updating customer: " + (err as Error).message);
        }
    };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        {errors.user?.username && (
                            <p className="text-red-500 text-sm">{errors.user.username.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.user?.password && (
                            <p className="text-red-500 text-sm">{errors.user.password.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.user?.fatherName && (
                            <p className="text-red-500 text-sm">{errors.user.fatherName.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.user?.fatherLastname && (
                            <p className="text-red-500 text-sm">{errors.user.fatherLastname.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.user?.motherName && (
                            <p className="text-red-500 text-sm">{errors.user.motherName.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.user?.motherLastname && (
                            <p className="text-red-500 text-sm">{errors.user.motherLastname.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.user?.dateOfBirth && (
                            <p className="text-red-500 text-sm">{errors.user.dateOfBirth.message}</p>
                        )}
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        {errors.personalInfo?.identityNumber && (
                            <p className="text-red-500 text-sm">{errors.personalInfo.identityNumber.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.personalInfo?.placeOfBirth && (
                            <p className="text-red-500 text-sm">{errors.personalInfo.placeOfBirth.message}</p>
                        )}
                    </div>
                </div>
            </fieldset>
